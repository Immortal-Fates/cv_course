...
int main()
{
    ...
    imwrite("../assets/equalized_1.jpg", result);  // 保存为JPG格式
    // 显示直方图对比
    ...
    imwrite("../assets/original_histogram1.jpg", origin_hist);      // 保存为JPG格式
    imwrite("../assets/equalized_histogram1.jpg", equalized_hist);  // 保存为JPG格式
